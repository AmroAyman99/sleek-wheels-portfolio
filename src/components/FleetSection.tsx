...
const vehicles = [
  ...
  },
  {
    ...
    features: ['Executive Seating', 'MBUX Infotainment', 'Burmester 4D Sound', 'Active Ambient Lighting', 'Driver Assistance Package']
  }
];
    ...
    <section className="section-padding bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          <Button className="bg-luxury-secondary hover:bg-luxury-secondary/90" size="lg" asChild>
