        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              <a href="#" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-luxury-primary hover:text-black transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <span className="text-gray-300">Washington, United States</span>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-luxury-primary mr-3" />
                <span className="text-gray-300">(202) 555-0123</span>
              </div>
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-luxury-primary mr-3" />
                <span className="text-gray-300">info@limomo.com</span>
              </div>
            </div>
          </div>
        </div>
